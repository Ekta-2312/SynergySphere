...
export const MyTasks: React.FC<MyTasksProps> = () => {
  ...
  const [filter, setFilter] = useState<'all' | 'todo' | 'in-progress' | 'in-review' | 'done'>(
    'all'
  );
  ...
  const isOverdue = (dueDate: string | undefined) => {
    ...
    return (
      new Date(dueDate) < new Date() && tasks.find(t => t.dueDate === dueDate)?.status !== 'done'
    );
  };
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex items-center space-x-6 text-sm text-gray-500'>
                    <div className='flex items-center space-x-1'>
                      ...
                      <span>
                        {typeof task.project === 'object' ? task.project.title : 'Unknown Project'}
                      </span>
                    </div>
