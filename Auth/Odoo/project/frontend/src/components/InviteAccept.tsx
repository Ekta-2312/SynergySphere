...
export const InviteAccept: React.FC = () => {
  ...
  const handleAcceptInvitation = async (e: React.FormEvent) => {
    ...
    if (!invitation.userExists) {
      ...
      setError('This email is already registered. Please enter your password to accept the invitation.');
      return;
    }
    ...
    try {
      ...
      if (error.message.includes('requires Login') || error.message.includes('provide your password')) {
        setShowPasswordField(true);
          ...
          {invitation?.isGoogleUser && (
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg">
                ...
                <p className="text-sm">
                  Please use Google Sign-In to accept this invitation.
                </p>
              </div>
