              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-red-700">
                    Once you delete this project, there is no going back. All tasks, discussions, and files will be permanently deleted.
                  </p>
                </div>
                <button
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">
                  Are you sure you want to delete "{project.title}"? This action cannot be undone and will permanently delete all project data.
                </p>
