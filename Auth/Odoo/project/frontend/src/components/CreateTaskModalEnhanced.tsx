...
export const CreateTaskModalEnhanced: React.FC<CreateTaskModalProps> = ({
  ...
  const [availableTags] = useState(['Frontend', 'Backend', 'Design', 'Testing', 'DevOps', 'Research', 'Documentation', 'Bug Fix', 'Feature', 'Enhancement']);
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Project: <span className="font-medium" style={{ color: project.color }}>{project.title}</span>
            </p>
          </div>
          <button
            onClick={onClose}
